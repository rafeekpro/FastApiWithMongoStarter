...
class TestMoviesAPI:
    ...
    async def test_get_movies_with_filter(self, client: AsyncClient, created_movie):
        ...
        response = await client.get(f"{settings.API_V1_STR}/movies", params={"title": "Test"})
    ...
    async def test_get_movies_with_pagination(self, client: AsyncClient):
        ...
        response = await client.get(f"{settings.API_V1_STR}/movies", params={"limit": 5, "offset": 0})
    ...
    async def test_update_movie(self, client: AsyncClient, created_movie):
        ...
        response = await client.put(f"{settings.API_V1_STR}/movies/{movie_id}", json=update_data)
    ...
    async def test_update_nonexistent_movie(self, client: AsyncClient):
        ...
        response = await client.put(f"{settings.API_V1_STR}/movies/{fake_id}", json={"name": "Updated"})
